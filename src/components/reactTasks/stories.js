...
export const Stories = [{ headline: `Test Headline`,
body: `This is a test story, to see if it works. Fingers crossed!`,
views: 10},
{headline: `Number of Fraudulent News Stories Set to Rise Exponentially`,
...
views: 50},
{headline:`Trump Eats Piccalilli, Vomits Heavily`,
...
views: 400},
{headline: `Creativity and Inspiration Wane`,
